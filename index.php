...
<!-- /Login Module -->
        ...
        <div id="signin-or-up" class="modal fade">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div style="align-content: center;">
                        <div class="modal-body">
                            <h1 class="modal-title" style="padding-bottom: 10px">Are you registered?</h1>

                            <button type="button" class="cbutton hue yes">Yes</button>
                            <button type="button" class="cbutton hue no">No</button>
                        </div>
                    </div>
                </div>
            </div>
...
<!--- no link -->
<script src="js/custom/nolink.js"></script>
</html>
